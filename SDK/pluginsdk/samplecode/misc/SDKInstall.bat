...
IF %PROCESSOR_ARCHITECTURE%==AMD64 (
 FOR /F "tokens=2* delims=	 " %%A IN ('REG QUERY "HKLM\SOFTWARE\Adobe\Photoshop\120.0\PluginPath" ') DO SET ps_cc_2018="%%B"
...
echo.
IF %PROCESSOR_ARCHITECTURE%==AMD64 (
 echo 1.  Photoshop CC  2018     %ps_cc_2018%
 echo 2.  Photoshop CC  2019     %ps_cc_2019%
 echo 3.  Photoshop     2020     %ps_2020%
 echo 4.  Photoshop     2021     %ps_2021%
 echo 5.  Photoshop     2022     %ps_2022%
 echo 6.  Photoshop     2023     %ps_2023%
) ELSE (
...
set userinp=I
if "%userinp%"=="1" goto CC201864
if "%userinp%"=="2" goto CC201964
if "%userinp%"=="3" goto NOCC202064
if "%userinp%"=="4" goto NOCC202164
if "%userinp%"=="5" goto NOCC202264
if "%userinp%"=="6" goto NOCC202364
if "%userinp%"=="I" goto DEFAULTCOMMON
echo Invalid Choice, quitting.
goto END
:CC201864
echo Photoshop CC 2018 64
set ps_install_path=%ps_cc_2018%
goto SDK
:CC201964
